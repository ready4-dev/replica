...
Additional attributes can be assigned using `ConditionalAttributeAdder`. The use of this class is demonstrated in the "Assigning Attributes Using Contingency Tables" vignette.

## Assign agents to households
After additional attributes have been assigned, agents can be grouped into households.

To do this, use the `HouseholdType` and `HouseholdGrouper` classes. These are described in another vignette.
