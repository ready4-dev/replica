...
Validation results are stored in `adder@validation_results` that includes the following elements:
...
Detailed validation results are available via `head(adder@validation_results$details)`.
