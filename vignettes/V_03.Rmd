...
In the "Assigning Attributes Using Contingency Tables" vignette we used `ConditionalAttributeAdder` to enrich a synthetic population with additional demographic attributes.
...
A more comprehensive discussion of population validation is provided in the next vignette.
...
tools described in the next vignette.
...
The resulting synthetic households can now be evaluated using the validation tools described in the next vignette.
