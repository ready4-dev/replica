...
However, right now it is mostly an exploratory R port of a python library that implements the algorithm described by [de Mooij et al.](https://link.springer.com/article/10.1007/s10458-024-09680-7).
