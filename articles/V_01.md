...
ConditionalAttributeAdder ↓ HouseholdGrouper ↓ Validation
...
Additional attributes can be assigned using `ConditionalAttributeAdder`.
The use of this class is demonstrated in the “Assigning Attributes Using
...
To do this, use the `HouseholdType` and `HouseholdGrouper` classes.
